...
<body>
    ...
    <nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" aria-label="Furni navigation bar">
        ...
        <div class="collapse navbar-collapse" id="navbarsFurni">
            ...
            <form class="d-flex" role="search" method="post" action="catalogo.php" id="formBuscar">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        <h1 class="text-center mt-5 mb-0">Categorías</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-4 col-lg-3 mb-5">
                    <a class="product-item" href="catalogo.php">
                        <img src="./img/iphone15azul-removebg-preview.png" class="img-fluid product-thumbnail">
                        <h3 class="product-title">Móviles</h3>
                    </a>
                </div>
            </div>
        </div>
